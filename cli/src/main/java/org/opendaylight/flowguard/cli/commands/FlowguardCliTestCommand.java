 ...
 */
package org.opendaylight.flowguard.cli.commands;
...
public class FlowguardCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(FlowguardCliTestCommand.class);
    protected final FlowguardCliCommands service;

    public FlowguardCliTestCommand(final FlowguardCliCommands service) {
